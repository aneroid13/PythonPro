...
class Test(unittest.TestCase):
    ...
    def test_log_string_parse(self):
        good_string = '''1.199.4.96 -  - [29/Jun/2017:03:50:22 +0300] "GET /api/v2/slot/4822/groups HTTP/1.1" 200 22 "-" "Lynx/2.8.8dev.9 libwww-FM/2.14 SSL-MM/1.4.1 GNUTLS/2.10.5" "-" "1498697422-3800516057-4708-9752773" "2a828197ae235b0b3cb" 0.157'''
        wrong_string = '''1.199.4.96 -  - [29/Jun/2017:03:50:22 +0300] "TUP /api/v2/slot/4822/groups HTTP/1.1" 200 22 "-" "Lynx/2.8.8dev.9 libwww-FM/2.14 SSL-MM/1.4.1 GNUTLS/2.10.5" "-" "1498697422-3800516057-4708-9752773" "2a828197ae235b0b3cb" 0.157'''
    ...
    def test_log_report(self):
        date = 20201020
        stat = [{"count": 2767, "time_avg": 62.994999999999997, "time_max": 9843.5689999999995, "time_sum": 174306.35200000001, "url": "/api/v2/internal/html5/phantomjs/queue/?wait=1m", "time_med": 60.073, "time_perc": 9.0429999999999993, "count_perc": 0.106}, {"count": 1410, "time_avg": 67.105999999999995, "time_max": 9853.3729999999996, "time_sum": 94618.864000000001, "url": "/api/v2/internal/gpmd_plan_report/queue/?wait=1m&worker=5", "time_med": 60.124000000000002, "time_perc": 4.9089999999999998, "count_perc": 0.053999999999999999}]
